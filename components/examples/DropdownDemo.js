...
export default class Demo extends Component {
  ...
  render() {
    let dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../../images/nha-bao-la.jpg') : require('../../images/nha-bao-la.jpg');
    return (
  ...
  _dropdown_2_renderRow(rowData, rowID, highlighted) {
    let icon = highlighted ? require('../../images/nha-bao-la.jpg') : require('../../images/nha-bao-la.jpg');
    let evenRow = rowID % 2;
    return (
